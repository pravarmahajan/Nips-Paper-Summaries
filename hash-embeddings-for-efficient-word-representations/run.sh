...
python src/main.py -ds amazon_full -K 1000000 -k 2 -B 150000 -d 200 -H 1000 1000 1000 -e 10 -b 128 -g -dict -emb hash


# With Dictionary, Deep Network, Std. Embedding (Sec 5.4)
python src/main.py -ds amazon_full -K 1000000 -k 2 -B 150000 -d 200 -H 1000 1000 1000 -e 10 -b 128 -g -dict -emb std
